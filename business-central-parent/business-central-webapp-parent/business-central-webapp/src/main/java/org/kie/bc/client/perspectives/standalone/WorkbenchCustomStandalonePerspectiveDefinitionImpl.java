...
@ApplicationScoped
public class WorkbenchCustomStandalonePerspectiveDefinitionImpl implements WorkbenchCustomStandalonePerspectiveDefinition {

    @Override
    public String getStandalonePerspectiveIdentifier() {
        return AuthoringPerspective.IDENTIFIER;
    }
