...
@ApplicationScoped
public class KieWorkbenchSecurity {

    @Inject
    private KieWorkbenchACL accessControlList;
    ...
    public void init() {
        kieSecurityService.call(new RemoteCallback<String>() {
            public void callback(final String str) {
                ...
                accessControlList.activatePolicy(policy);
            }
        }).loadPolicy();
    }

    public Set<String> getRoles(String featureId) {
        return accessControlList.getGrantedRoles(featureId);
    }
}
