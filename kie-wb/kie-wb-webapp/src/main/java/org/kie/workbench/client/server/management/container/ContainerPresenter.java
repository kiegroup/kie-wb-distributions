...
package org.kie.workbench.client.server.management.container;
...
import org.kie.workbench.client.server.management.container.config.process.ContainerProcessConfigPresenter;
import org.kie.workbench.client.server.management.container.config.rules.ContainerRulesConfigPresenter;
import org.kie.workbench.client.server.management.container.status.ContainerRemoteStatusPresenter;
import org.kie.workbench.client.server.management.events.ContainerSpecSelected;
import org.kie.workbench.client.server.management.events.RefreshRemoteServers;
...
public class ContainerPresenter {
    ...
    public interface View extends UberView<ContainerPresenter> {
        ...
        void setStatus( final ContainerRemoteStatusPresenter.View view );
    ...
    public void load( final ContainerSpecKey containerSpecKey ) {
        ...
        } ).getContainers( checkNotNull( "containerSpecKey", containerSpecKey ) );
    }
