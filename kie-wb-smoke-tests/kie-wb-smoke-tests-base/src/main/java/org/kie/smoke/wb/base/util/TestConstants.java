...
package org.kie.smoke.wb.base.util;
...
public class TestConstants {
    ...
    public final static String DEPLOYABLE_ARTIFACTID;;
    public final static String DEPLOYABLE_CLASSIFIER;;
    static {
        ...
        DEPLOYABLE_ARTIFACTID = testProps.getProperty("deployable.artifactId");
        DEPLOYABLE_CLASSIFIER = testProps.getProperty("deployable.classifier");
    }
