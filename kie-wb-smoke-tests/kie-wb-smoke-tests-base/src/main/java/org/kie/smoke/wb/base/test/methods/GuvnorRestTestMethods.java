...
import static org.kie.smoke.wb.base.util.RestUtil.delete;
import static org.kie.smoke.wb.base.util.RestUtil.get;
import static org.kie.smoke.wb.base.util.RestUtil.post;
import static org.kie.smoke.wb.base.util.RestUtil.postEntity;
...
public class GuvnorRestTestMethods {

    private final static int maxTries = 10;
     ...
     * @throws Exception
     */
    public static void doTestManipulatingOUs(URL deploymentUrl, String mediaType, String user, String password) throws Exception {
        int origUnitsSize;
...

        {
            ...
            for( int i = 0; i < 2; ++i ) {
                ...
                orgUnit.setOwner(GuvnorRestTestMethods.class.getSimpleName());
                ...
                // rest/jobs/{jobId}
                waitForJobToComplete(deploymentUrl, mediaType, user, password,
                        createOURequest.getJobId(), createOURequest.getStatus());
        ...
        String repoName = UUID.randomUUID().toString();
        {
            ...
            // rest/jobs/{jobId}
           waitForJobToComplete(deploymentUrl, mediaType, user, password,
                   createRepoRequest.getJobId(), createRepoRequest.getStatus());
        }

        {
            ...
            // rest/jobs/{jobId}
            waitForJobToComplete(deploymentUrl, mediaType, user, password,
                    addRepoToOuRequest.getJobId(), addRepoToOuRequest.getStatus());
        }
...

        {
            ...
            // rest/jobs/{jobId}
            waitForJobToComplete(deploymentUrl, mediaType, user, password,
                    remRepoFromOuRquest.getJobId(), remRepoFromOuRquest.getStatus());
        }
...

        {
            ...
            waitForJobToComplete(deploymentUrl, mediaType, user, password,
                    removeOrgUnitRequest.getJobId(), removeOrgUnitRequest.getStatus());
        }
     ...
     */
    public static void doTestManipulatingRepositoriesAndProjects(URL deploymentUrl, String mediaType, String user, String password) throws Exception {
        String orgUnitName = "repo-user-" + ouSdf.format(new Date());
        {
            ...
            orgUnit.setOwner(GuvnorRestTestMethods.class.getName());
            ...
            // rest/jobs/{jobId} GET
            waitForJobToComplete(deploymentUrl, mediaType, user, password,
                    jobId, createOuRequest.getStatus());
        }
        ...
        String repoName = UUID.randomUUID().toString();
        {
            ...
            // rest/jobs/{jobId} GET
            waitForJobToComplete(deploymentUrl, mediaType, user, password,
                    createJobRequest.getJobId(), createJobRequest.getStatus());
        }

        {
            ...
            // rest/jobs/{jobId} GET
            waitForJobToComplete(deploymentUrl, mediaType, user, password,
                    createProjectRequest.getJobId(), createProjectRequest.getStatus());
        }
...

        {
            ...
            // rest/jobs/{jobId} GET
            waitForJobToComplete(deploymentUrl, mediaType, user, password,
                    jobId, delProjectRequest.getStatus());
        }
...

        {
            ...
            // rest/jobs/{jobId} GET
            waitForJobToComplete(deploymentUrl, mediaType, user, password,
                    jobId, remRepoFromOuRequest.getStatus());
        }
...

        {
            ...
            // rest/jobs/{jobId} GET
            waitForJobToComplete(deploymentUrl, mediaType, user, password,
                    jobId, delRepoRequest.getStatus());
        }
     ...
     * @throws Exception
     */
    public static void doTestMavenOperations(URL deploymentUrl, String mediaType, String user, String password) throws Exception {
        // rest/repositories GET
...

        {
            ...
            // rest/jobs/{jobId} GET
            waitForJobToComplete(deploymentUrl, mediaType, user, password,
                    compileRequest.getJobId(), compileRequest.getStatus());
        }

    }

    private static JobResult waitForJobToComplete(URL deploymentUrl, String mediaType, String user, String password,
            String jobId, JobStatus jobStatus) throws Exception {
        return waitForJobToHaveStatus(deploymentUrl, jobId, jobStatus, JobStatus.SUCCESS, mediaType, user, password);
    }

    private static JobResult waitForJobToHaveStatus(URL deploymentUrl, String jobId, JobStatus jobStatus, JobStatus expectedStatus,
            String mediaType, String user, String password) throws Exception {
