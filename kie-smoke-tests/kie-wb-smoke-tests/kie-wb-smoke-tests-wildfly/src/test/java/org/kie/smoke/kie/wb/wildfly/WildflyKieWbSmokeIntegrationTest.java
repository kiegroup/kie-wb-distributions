 ...
 */
package org.kie.smoke.kie.wb.wildfly;
...
public class WildflyKieWbSmokeIntegrationTest extends AbstractKieWbSmokeIntegrationTest {

    @Deployment(testable = false, name = "kie-wb-wildfly")
    public static Archive<?> createWar() {
        logger.debug("Retrieving kie-wb wildfly8 war");
        WebArchive war = getWebArchive("org.kie", "kie-wb-distribution-wars", "wildfly8", PROJECT_VERSION);
        return war;
    }
