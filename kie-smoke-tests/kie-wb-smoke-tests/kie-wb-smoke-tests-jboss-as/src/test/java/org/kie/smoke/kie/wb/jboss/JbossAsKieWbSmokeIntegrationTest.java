 ...
 */
package org.kie.smoke.kie.wb.jboss;
...
public class JbossAsKieWbSmokeIntegrationTest extends AbstractKieWbSmokeIntegrationTest {

    @Deployment(testable = false, name = "kie-wb-as7")
    public static Archive<?> createWar() {
        logger.debug("Retrieving kie-wb as7 war");
