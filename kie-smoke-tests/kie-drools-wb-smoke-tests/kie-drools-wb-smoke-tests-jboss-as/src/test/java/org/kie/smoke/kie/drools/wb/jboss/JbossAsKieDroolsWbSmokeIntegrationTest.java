 ...
 */
package org.kie.smoke.kie.drools.wb.jboss;
...
public class JbossAsKieDroolsWbSmokeIntegrationTest extends AbstractKieDroolsWbSmokeIntegrationTest {

    @Deployment(testable = false, name = "kie-drools-wb-as7")
    public static Archive<?> createWar() {
        logger.debug("Retrieving kie-drools-wb as7 war");
