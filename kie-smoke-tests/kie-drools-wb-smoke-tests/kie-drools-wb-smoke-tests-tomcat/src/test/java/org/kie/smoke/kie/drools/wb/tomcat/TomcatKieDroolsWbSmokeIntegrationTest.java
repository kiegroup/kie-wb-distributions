 ...
 */
package org.kie.smoke.kie.drools.wb.tomcat;

import static org.kie.smoke.kie.drools.wb.base.util.TestConstants.*;
...
public class TomcatKieDroolsWbSmokeIntegrationTest extends AbstractKieDroolsWbSmokeIntegrationTest {

    @Deployment(testable = false, name = "kie-drools-wb-tomcat")
    public static Archive<?> createWar() {
        logger.debug("Retrieving kie-drools-wb tomcat7 war");
